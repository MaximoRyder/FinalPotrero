...
function InlineLink(emailParameters: any = {}) {
  ...
  function renderEmail(emailComponent) {
    ...
    return `${doctype}${_server2.default.renderToStaticMarkup(emailComponent).replaceAll('/img/', 'https://proyectospotrerodigital.aptugo.app/img/')}`
  }
...
const recoverPasswordFormat = (to, extra: any = {}) => {
  ...
  axios({
    method: 'POST',
    url: 'https://proyectospotrerodigital.backend.aptugo.app/api/sendEmail',
    data: {
      name: from,
      email: to,
