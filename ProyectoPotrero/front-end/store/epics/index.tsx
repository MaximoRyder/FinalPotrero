...
import cohortesEpics from './cohortesEpics'
import especializacionesEpics from './especializacionesEpics'
import proyectosEpics from './proyectosEpics'

export const rootEpic = combineEpics(proyectosEpics, cohortesEpics, especializacionesEpics)
